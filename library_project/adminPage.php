...
{
	$insert="INSERT INTO bookinfo VALUES('$serial','$title','$author','$quantity')";
	if(!mysqli_query($connect,$insert))
		echo "<script>alert('There was a problem adding the Book or it already exists in the Library.');</script>";
	else echo "<script>alert('The book and quantity is now added');</script>";
}

elseif(isset($_POST['submitD']))
{
	$del="DELETE FROM bookinfo WHERE serial='$delBook' and quantity='$quantity'";
...
<br>
<input type=number name=quantity placeholder="quantity to delete a Book"><br>
<br>
